...
def parameters():
    ...
    # params.target_refound_threshold = 0.15 #0.25 params.target_not_found_threshold
    ...
    if params.use_rgbd_classifier:
            ...
            params.depth_features_filter = MultiResolutionExtractor([deep_feat_filter])

    params.use_normalized_DCF =  False # RGB is normalized in ResNet50
    params.use_normalized_depth = False # True

    params.model = 'depth_segm_rgbd_feat_dcf_pre_redet08'
