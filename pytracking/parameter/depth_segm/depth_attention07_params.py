...
def parameters():
    ...
    params.constructor_fun_name = 'depth_segm_attention07_resnet50'
    params.segm_net_path = '/home/yan/Data2/d3s/checkpoints/ltr/depth_segm/depth_segm_attention07/DepthSegmNet_ep0040.pth.tar'
