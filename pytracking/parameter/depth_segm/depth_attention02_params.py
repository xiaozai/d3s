...
def parameters():
    ...
    params.constructor_fun_name = 'depth_segm_attention02_resnet50'
    params.segm_net_path = '/home/yan/Data2/d3s/checkpoints/ltr/depth_segm/depth_segm_attention2/DepthSegmNet_ep0040.pth.tar'
