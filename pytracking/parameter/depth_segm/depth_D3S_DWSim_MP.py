...
def parameters():
    ...
    params.constructor_fun_name = 'depth_segm_D3S_DWSim_MP_resnet50'
    params.segm_net_path = '/home/yan/Data2/d3s/checkpoints/ltr/depth_segm/depth_segm_D3S_DWSim_MP/DepthSegmNet_ep0040.pth.tar'
