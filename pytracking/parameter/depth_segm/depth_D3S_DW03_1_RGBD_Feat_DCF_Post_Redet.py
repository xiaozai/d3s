...
def parameters():
    ...
    params.model = 'depth_segm_rgbd_feat_dcf_post_redet'
    params.constructor_module = 'ltr.models.depth_segm.depth_segm'
    params.constructor_fun_name = 'depth_segm_D3S_DW03_1_MP_resnet50'
    params.segm_net_path = '/home/yan/Data2/d3s/checkpoints/ltr/depth_segm/depth_segm_D3S_DW03_1/DepthSegmNet_ep0040.pth.tar'
