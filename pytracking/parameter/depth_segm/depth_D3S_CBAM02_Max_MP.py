...
def parameters():
    ...
    params.constructor_fun_name = 'depth_segm_D3S_CBAM02_2_MP_resnet50'
    params.segm_net_path = '/home/yan/Data2/d3s/checkpoints/ltr/depth_segm/depth_segm_D3S_CBAM02_2_MP/DepthSegmNet_ep0020.pth.tar'
