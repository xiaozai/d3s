...
def parameters():
    ...
    params.train_skipping = 30 # 10                   # How often to run training (every n-th frame)
    ...
    if params.use_rgbd_classifier:
        deep_depth_feat_filter = deep.ATOMResNet50(output_layers=['layer3'], fparams=deep_fparams, normalize_power=2,
                                                   net_path='/home/yan/Data2/DeT-models/DeT_DiMP50_Max.pth')
        params.depth_features_filter = MultiResolutionExtractor([deep_depth_feat_filter])
    ...
    params.use_normalized_depth = False

    params.model = 'depth_segm_rgbd_resnet_dcf_pre_redet'
    params.constructor_module = 'ltr.models.depth_segm.depth_segm'
    params.constructor_fun_name = 'depth_segm_D3S_DW03_RGBD_resnet50'
    params.segm_net_path = '/home/yan/Data2/d3s/checkpoints/ltr/depth_segm/depth_segm_D3S_DW03_RGBD_Resnet_Feat/DepthSegmNet_ep0024.pth.tar'
