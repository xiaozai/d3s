...
def run(settings):
    ...
    settings.batch_size = 32 # 64  # Batch size
    ...
    settings.env.images_dir = os.path.join(settings.env.workspace_dir, 'images_rgbd')
    ...
    net = segm_models.depth_init_segm_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
