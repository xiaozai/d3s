...
def run(settings):
    ...
    settings.env.images_dir = os.path.join(settings.env.workspace_dir, 'images_rgbd2_1')
    ...
    net = segm_models.depth_segm_attention02_1_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
