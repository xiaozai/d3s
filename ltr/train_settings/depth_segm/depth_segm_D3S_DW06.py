...
def run(settings):
    ...
    settings.search_area_factor = 4.5  # Image patch size relative to target size
    ...
    settings.env.images_dir = os.path.join(settings.env.workspace_dir, 'images_D3S_DW06')
    ...
    net = segm_models.depth_segm_D3S_DW06_MP_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
