...
def run(settings):
    ...
    settings.search_area_factor = 3.0 # 4.0  # Image patch size relative to target size
    ...
    settings.env.images_dir = os.path.join(settings.env.workspace_dir, 'images_rgbd_attn12')
    ...
    net = segm_models.depth_segm_attention12_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
