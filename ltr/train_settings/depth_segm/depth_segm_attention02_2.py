...
def run(settings):
    ...
    settings.batch_size = 24  # Batch size
    ...
    settings.env.images_dir = os.path.join(settings.env.workspace_dir, 'images_rgbd2_2')
    ...
    net = segm_models.depth_segm_attention02_2_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
