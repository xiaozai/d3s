...
def run(settings):
    ...
    settings.env.images_dir = os.path.join(settings.env.workspace_dir, 'images_D3S_DW05')
    ...
    net = segm_models.depth_segm_D3S_DW05_MP_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
    ...
    actor = actors.DepthSegmActor_DepthGaussian(net=net, objective=objective, loss_weights=[1.0, 0.5, 0.5, 0.5])
