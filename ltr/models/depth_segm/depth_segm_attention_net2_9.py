...
class DepthSegmNetAttention(nn.Module):
    def __init__(self):
        ...
        self.rgbd_transformers = nn.ModuleList([Transformer(config0, (384, 192), 4, True, mask_pool=True),
                                                Transformer(config1, (192, 96), 16, True, mask_pool=True),
                                                Transformer(config2, (96, 48), 32, True, mask_pool=True),
