...
class DepthSegmNetAttention(nn.Module):
    ...
    def forward(self, feat_test_rgb, feat_test_d, feat_train_rgb, feat_train_d, mask_train, test_dist=None, debug=False):
        ...
        out, attn_weights3 = self.process(out, feat_test_rgb, feat_test_d, feat_train_rgb, feat_train_d, mask_train, layer=3)
        out, attn_weights2 = self.process(out, feat_test_rgb, feat_test_d, feat_train_rgb, feat_train_d, mask_train, layer=2)
        out, attn_weights1 = self.process(out, feat_test_rgb, feat_test_d, feat_train_rgb, feat_train_d, mask_train, layer=1)
